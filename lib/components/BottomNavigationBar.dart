      ...
      bottomNavigationBar: Obx(
        () => NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(icon: Icon(Icons.analytics_outlined,color: Colors.white), label: 'analytics'),
            NavigationDestination(icon: Icon(Icons.account_circle,color: Colors.white), label: 'Account'),
          ],
        ),
      ),
